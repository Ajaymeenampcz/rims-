...
{
    public class KPIDtrMeteringController : ApiController
    {
        [HttpGet]
        [Route("api/KPIDtrMetering/{company}/{circle}/{dtr_type}/{quarter1}/{year1}/{quarter2}/{year2}/{quarter3}/{year3}/{quarter4}/{year4}")]
